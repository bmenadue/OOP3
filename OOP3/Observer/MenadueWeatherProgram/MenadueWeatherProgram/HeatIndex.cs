...
{
    public class HeatIndex : DisplayElement, Observer
    {
        private double heatIndex = 0.0f;
        private WeatherData weatherData;
        public void HeatIndexDisplay(WeatherData weatherData)
        {
        ...
        public void update(double temp, double rh, double pressure)
        {
